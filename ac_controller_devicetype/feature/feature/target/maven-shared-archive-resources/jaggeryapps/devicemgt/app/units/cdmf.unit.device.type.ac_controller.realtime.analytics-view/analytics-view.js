...
function onRequest(context) {
	...
	var websocketEndpointForStream1 = websocketEndpoint + "/secured-websocket/org.wso2.iot.devices.Temprature/1.0.0?deviceId=" + device.deviceIdentifier + "&deviceType=" + device.type;
