...
package org.smartbuilding.ac_controller.api;

import org.smartbuilding.ac_controller.api.dto.DeviceJSON;
import org.smartbuilding.ac_controller.api.dto.SensorRecord;
import org.smartbuilding.ac_controller.api.util.APIUtil;
import org.smartbuilding.ac_controller.api.util.ZipUtil;
import org.smartbuilding.ac_controller.api.util.ZipArchive;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "ac_controller"));
            APIUtil.getDeviceManagementService().addOperation("ac_controller", commandOp,
                                                              deviceIdentifiers);
