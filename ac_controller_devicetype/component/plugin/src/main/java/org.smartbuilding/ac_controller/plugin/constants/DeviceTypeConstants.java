...
package org.smartbuilding.ac_controller.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "ac_controller";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "ac_controller_DEVICE_ID";
    public final static String STATE_ON = "ON";
    public final static String STATE_OFF = "OFF";

    //sensor events summerized table name
    public static final String SENSOR_TYPE1_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_Temprature";
    public static final String SENSOR_TYPE2_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_Humidity";
    public static final String DATA_SOURCE_NAME = "jdbc/ac_controllerDM_DB";
    public final static String DEVICE_TYPE_PROVIDER_DOMAIN = "carbon.super";
    public final static String SENSOR_TYPE1 = "Temprature";
    public final static String SENSOR_TYPE2 = "Humidity";

    //mqtt tranport related constants
    public static final String MQTT_ADAPTER_NAME = "Temprature_mqtt";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/ac_controller/+/Temprature";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.Temprature";
