...
package org.smartbuilding.ac_controller.plugin.impl.util;
...
/**
 * Contains utility methods used by ac_controller plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.smartbuilding.ac_controller.plugin.impl.util.DeviceTypeUtils.class);
